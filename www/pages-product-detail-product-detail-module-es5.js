  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-product-detail-product-detail-module"], {
    ...
    function KLt4(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProductDetailPage = /*#__PURE__*/function () {
        function ProductDetailPage(route, router, http, toastController) {
        ...
        _createClass(ProductDetailPage, [{
          ...
          value: function ngOnInit() {
            ...
            this.http.post(src_app_api_url__WEBPACK_IMPORTED_MODULE_6__["APIURL"].apiURL + 'get_detail_product', reqData).subscribe(function (data) {
              _this.product = {
              ...
              _this.product_variant = data['variant'];
              _this.nutrisi = data['keterangan'];
              _this.jumData = _this.product_variant.length;
            });
          }
        }, {
          key: "isLogging",
          ...
          key: "increment",
          value: function increment(price) {
            if (price.quantity === 1) {
              this.disable = false;
            }
          ...
          key: "decrement",
          value: function decrement(price) {
            if (price.quantity < 1) {
              this.disable = true;
            } else {
              price.quantity--;
          ...
          value: function addToCart() {
            ...
            for (var i = 0; i < this.jumVarian; i++) {
            ...
            this.http.post(src_app_api_url__WEBPACK_IMPORTED_MODULE_6__["APIURL"].apiURL + 'process_order_item', reqData).subscribe(function (data) {
              console.log(reqData);
              var sts = data['status'];
              ...
              if (sts == "Failed") {
                ...
                setTimeout(function () {
                  _this2.router.navigate(['/tabs/cart']);
                }, 900);
              }
            });
          }
